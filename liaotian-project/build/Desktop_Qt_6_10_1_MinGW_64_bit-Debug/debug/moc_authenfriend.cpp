...
namespace {
struct qt_meta_tag_ZN12AuthenFriendE_t {};
} // unnamed namespace

template <> constexpr inline auto AuthenFriend::qt_create_metaobjectdata<qt_meta_tag_ZN12AuthenFriendE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'SlotRemoveFriendLabel'
        QtMocHelpers::SlotData<void(QString)>(4, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 2 },
        }}),
        // Slot 'SlotChangeFriendLabelByTip'
        QtMocHelpers::SlotData<void(QString, ClickLbState)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 2 }, { 0x80000000 | 6, 2 },
        }}),
        // Slot 'SlotLabelTextChange'
        QtMocHelpers::SlotData<void(const QString &)>(7, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 8 },
        }}),
        // Slot 'SlotLabelEditFinished'
        QtMocHelpers::SlotData<void()>(9, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'SlotAddFirendLabelByClickTip'
        QtMocHelpers::SlotData<void(QString)>(10, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 8 },
        }}),
        // Slot 'SlotApplySure'
        QtMocHelpers::SlotData<void()>(11, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'SlotApplyCancel'
    ...
    return QtMocHelpers::metaObjectData<AuthenFriend, qt_meta_tag_ZN12AuthenFriendE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject AuthenFriend::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12AuthenFriendE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12AuthenFriendE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN12AuthenFriendE_t>.metaTypes,
    nullptr
} };
...
void *AuthenFriend::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12AuthenFriendE_t>.strings))
